package andre.hitchman.com.news.network.mocks
...
object NewsArticleResponseMock {
    ...
    val SECTION_ITEMS: List<NewsArticleItemSectionBodyElement> =
        listOf(
            NewsArticleItemSectionBodyElement.ImageUrl("www.hero.com"),
            NewsArticleItemSectionBodyElement.SectionText("section")
        )
    val listOfSections: List<SectionResponse> =
        listOf(SectionResponse("section title", SECTION_ITEMS))
    val SECTIONS_LIST: List<NewsArticleItemSection> =
        listOf(NewsArticleItemSection("section title", SECTION_ITEMS))

    fun generateNewsArticles(
        ...
        listOf(mockNewsArticle(teaser, title, heroUrl, sections))
    )
